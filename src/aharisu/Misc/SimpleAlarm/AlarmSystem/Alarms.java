...
import aharisu.Misc.SimpleAlarm.AlarmWidget;
...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "aharisu.Misc.SimpleAlarm.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "aharisu.Misc.SimpleAlarm.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "aharisu.Misc.SimpleAlarm.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "aharisu.Misc.SimpleAlarm.ALARM_DISMISS";
    ...
    public static Cursor getAlarmsCursor(ContentResolver contentResolver) {
        return contentResolver.query(
                ...
                null, null, null );//Alarm.Columns.DEFAULT_SORT_ORDER);
    }
    ...
    private static ContentValues createContentValues(Alarm alarm) {
        ...
        values.put(Alarm.Columns.ALERT, alarm.alert == null ? "" : alarm.alert.toString());
    ...
    public static Alarm getAlarm(Context context, int alarmId) {
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                alarm = new Alarm(cursor, context);
            }
            cursor.close();
        }
        return alarm;
    ...
    public static void enableAlarm(
        ...
        enableAlarmInternal(context, getAlarm(context, id), enabled);
        setNextAlert(context);
    }
    ...
    private static void enableAlarmInternal(final Context context,
        ...
        if (enabled) {
            values.put(Alarm.Columns.ALARM_TIME, calculateAlarm(alarm));
        } else {
    ...
    public static Alarm calculateNextAlert(final Context context) {
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    Alarm a = new Alarm(cursor, context);
    ...
    public static void disableExpiredAlarms(final Context context) {
        ...
        if (cur.moveToFirst()) {
            do {
                Alarm alarm = new Alarm(cur, context);
    ...
    public static void setNextAlert(final Context context) {
        ...
        intent.setAction(AlarmWidget.ActionViewUpdate);
    ...
    private static boolean enableSnoozeAlert(final Context context) {
        ...
        final Alarm alarm = getAlarm(context, id);
        if (alarm == null) {
            return false;
        }
