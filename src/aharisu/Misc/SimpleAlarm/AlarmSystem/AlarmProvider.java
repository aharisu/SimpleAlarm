...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("aharisu.Misc.SimpleAlarm", "alarm", ALARMS);
        sURLMatcher.addURI("aharisu.Misc.SimpleAlarm", "alarm/#", ALARMS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String insertMe = "INSERT INTO alarms " +
                    "(hour, minutes, alarmtime, enabled, volume, alert) " +
                    "VALUES ";
            db.execSQL(insertMe + "(8, 30, 0, 0, 6,'');");
            db.execSQL(insertMe + "(9, 00, 0, 0, 8, '');");
        }
